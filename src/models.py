...
class BaseModel(object):
    def __init__(self, sess, options):
        ...
        self.dataset_train = DataSet('/srv/glusterfs/xieya/data/places365_standard/train.txt')
        self.dataset_test = DataSet('/srv/glusterfs/xieya/data/places365_standard/val.txt', 4)
